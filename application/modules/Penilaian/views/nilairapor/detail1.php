                                        ...
                                        <div class="form-row align-items">
                                            ...
                                            <div class="col-auto">
                                                <div class="input-group">
                                                    <textarea class="form-control" rows="2" onkeyup="deskripsik('<?= $row->nisn ?>','<?= $kode ?>')" id="deskripsi<?= $row->nisn ?>" PLACEHOLDER="Deskripsi"><?= $dkk ?></textarea>
                                                </div>
                                            </div>
...
<script>
    function nilaiuhk(nisn, kode) {
        ...
        $.ajax({
            ...
            data: 'nilai1=' + nilai1 + '&nisn=' + nisn + '&kodeJadwal=' + kodeJadwal + '&tahun_akademik=' + tahun_akademik,
