                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="kodeTahun">
                                    ...
                                    <?php foreach ($tahun as $tahun) { ?>
                                        <option value="<?php echo $tahun->kodeTahun; ?>"><?php echo $tahun->kodeTahun; ?> - <?= $tahun->namaTahun ?> </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-control" name="namaHari">
                                    ...
                                    <?php foreach ($hari as $hari) { ?>
                                        <option value="<?php echo $hari->namaHari; ?>"><?= $hari->idHari ?> - <?= $hari->namaHari ?> </option>
                                    <?php } ?>
                                </select>
                                <div class="invalid-feedback">
                                    Harus diisi!
