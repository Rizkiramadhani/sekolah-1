            ...
            <div class="card-body">
                <form class="needs-validation" novalidate="" action="<?= base_url($linkin . '/editAction/' . $this->uri->segment(4)) ?>" method="post">
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Kode Tahun</label>
                        <input type="text" class="form-control" value="<?= $row->kodeTahun ?>" name="kodeTahun" id="validationCustom01" required>
                    ...
                    <div class="form-group mb-3">
                        <label for="validationCustom01">Nama Tahun</label>
                        <input type="text" class="form-control" name="namaTahun" value="<?= $row->namaTahun ?>" id="validationCustom01">
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" value="<?= $row->keterangan ?>" name="keterangan" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
