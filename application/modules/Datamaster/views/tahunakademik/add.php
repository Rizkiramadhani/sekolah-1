            ...
            <div class="card-body">
                <form action="<?= base_url($linkin . '/addAction') ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="kodeTahun" id="validationCustom01" required>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="namaTahun" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control" name="keterangan" id="validationCustom01" required>
                        <div class="invalid-feedback">
                            Harus diisi!
                        </div>
                    </div>
