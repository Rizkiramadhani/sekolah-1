                ...
                <div class="card-body">
                    <div class="text-center mt-3">
                        ...
                        <h6 class="text-muted font-weight-normal mt-2 mb-0">NIP : <?= $row->nip ?>
                            <h6 class="text-muted font-weight-normal mt-2 mb-0">Jenis PTK : <?= $row->jenisPtk ?>
                            </h6>
                            <h6></h6>
                            <!-- <h6 class="text-muted font-weight-normal mt-1 mb-4">San Francisco, CA</h6> -->

                            <a href="<?= base_url($linkin . '/edit/' . $row->idGuru) ?>"> <button type="button" class="btn btn-primary btn-sm mr-1">Edit Profil</button></a>
                        ...
                        <div class="tab-pane fade show active" id="pills-activity" role="tabpanel" aria-labelledby="pills-activity-tab">
                            ...
                            <form class="row g-4">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" value="<?= $row->nik ?>" disabled>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label for="inputAddress" class="form-label">Nama Lengkap</label>
                                    <input type="text" class="form-control" id="inputAddress" value="<?= $row->namaGuru ?>" disabled>
                                </div>
                                <div class="col-md-6 mt-3">
                                ...
                                <div class="col-md-6 mt-3">
                                    ...
                                    <input type="text" class="form-control" id="inputAddress" value="<?= $row->email ?>" disabled>
                                </div>
                                <div class="col-md-6 mt-3">
                                    <label for="inputAddress" class="form-label">Tugas Tambahan</label>
                                    <input type="text" class="form-control" id="inputAddress" value="<?= $row->tugasTambahan ?>" disabled>
                                </div>
