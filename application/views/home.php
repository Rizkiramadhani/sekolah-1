            ...
            <div class="container-fluid">
                ...
                <a href="index.html" class="navbar-brand mr-0 mr-md-2 logo">
                    <span class="logo-lg">
                        ...
                        <span class="d-inline h5 ml-1 text-logo">SMP Negeri 2 Muara Uya</span>
                    </span>
                    <span class="logo-sm">
                        <img src="<?= base_url() ?>assets/images/tutwurihanda.png" alt="" height="24">
                    </span>
                    ...
                    <li class="dropdown notification-list align-self-center profile-dropdown">
                        <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <div class="media user-profile ">
                                <img src="<?= base_url() ?>assets/images/profil/<?= $row->foto ?>" alt="user-image" class="rounded-circle align-self-center" />
                        ...
                        <div class="dropdown-menu profile-dropdown-items dropdown-menu-right">
                            ...
                            <!-- <a href="<?= base_url('Home/Pengaturan/umum') ?>" class="dropdown-item notify-item">
                        ...
                        <?php else : ?>
                            <li>
                                ...
                                <!-- <ul class="nav-second-level" aria-expanded="false">
                                    <?php if (empty($re)) : ?>
                                        <li class="">
                                            <a href="javascript: void(0);" aria-expanded="false" class="mm-collapsed">Pengajuan Proposal
                                                <span class="menu-arrow"></span>
                                            </a>
                                            <ul class="nav-third-level mm-collapse" aria-expanded="false">
                                                <li>
                                                    <a href="<?= base_url('Home/Hibah/Penelitian') ?>">Penelitian</a>
                                                </li>
                                                <li>
                                                    <a href="<?= base_url('Home/Hibah/Pkm') ?>">PKM</a>
                                                </li>
                                            </ul>
                                        </li>
                                        <li class="">
                                            <a href="javascript: void(0);" aria-expanded="false" class="mm-collapsed">Daftar Proposal
                                                <span class="menu-arrow"></span>
                                            </a>
                                            <ul class="nav-third-level mm-collapse" aria-expanded="false">
                                                <li>
                                                    <a href="<?= base_url('Home/Hibah') ?>">Daftar Proposal</a>
                                                </li>
                                                 <li>
                                                                <a href="<?= base_url('Home/Hibah') ?>">PKM</a>
                                                            </li> 
                                            </ul>
                                        </li>
                                        <li class="">
                                            <a href="javascript: void(0);" aria-expanded="false" class="mm-collapsed">Download Template
                                                <span class="menu-arrow"></span>
                                            </a>
                                            <ul class="nav-third-level mm-collapse" aria-expanded="false">
                                                <li>
                                                    <a href="<?= base_url('assets/templatehibah/penelitian.docx') ?>">Penelitian</a>
                                                </li>
                                                <li>
                                                    <a href="<?= base_url('assets/templatehibah/PKM.docx') ?>">PKM</a>
                                                </li>
                                            </ul>
                                        </li>
                                    <?php else : ?>
                                        <li>
                                            <a href="<?= base_url('Home/Review') ?>">Daftar Proposal</a>
                                        </li>
                                    <?php endif ?>
                                </ul> -->
                            </li>
